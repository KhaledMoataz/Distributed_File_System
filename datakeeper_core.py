    ...
    def run(self):
        while True:
            ...
            if request.startswith("upload"):
                ...
                replicas_master_socket.send_string('{} {} {} {}'.format(file_name, id, server_port, port))
                response = replicas_master_socket.recv_string()
                print(response)


def init_data_keeper_process(replicas_master_ip, replicas_master_port, server_ip, server_port, id):
    data_keeper = Date_Keeper(server_ip, server_port, id)
